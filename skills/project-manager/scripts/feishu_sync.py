...
示例：
    python feishu_sync.py https://your-company.feishu.cn/wiki/DOCUMENT_TOKEN "output_dir" "文档名称"
"""
...
def main():
    if len(sys.argv) < 3:
        ...
        print("\n示例:")
        print('  python feishu_sync.py https://your-company.feishu.cn/wiki/DOCUMENT_TOKEN "output_dir"')
        print('  python feishu_sync.py https://your-company.feishu.cn/wiki/DOCUMENT_TOKEN "output_dir" "文档名称"')
        sys.exit(1)
