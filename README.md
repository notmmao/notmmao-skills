...
| `md2slide` | Markdown转HTML幻灯片工具，支持双语标题、语义色彩块、代码高亮、多列布局、卡片网格、时间线、多种主题和过渡效果，生成单文件自包含演示文稿 |
...
npx skills add https://github.com/notmmao/notmmao-skills --skill md2slide
```
